...
About::About(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	StaticText2 = new wxStaticText(Panel1, ID_STATICTEXT2, _T("MPC ASF 编辑器 V1.7.5"), wxPoint(130,24), wxDefaultSize, 0, _T("ID_STATICTEXT2"));
	...
	StaticText6 = new wxStaticText(Panel1, ID_STATICTEXT6, _T("2021.03.02"), wxPoint(136,160), wxDefaultSize, 0, _T("ID_STATICTEXT6"));
